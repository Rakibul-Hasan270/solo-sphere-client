...
//   // const { category, status, price, deadline, comment, job_title } = myBid;
...
//                 {
//                   myBid.map(bid => <tbody className='bg-white divide-y divide-gray-200 '>
//                     <tr>
                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                  {myBid.map((bid) => (
                    <tr key={bid._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-2'>
                          <p className='px-3 py-1 rounded-full text-blue-500 bg-blue-100/60 text-xs'>{bid.category}</p>
                        </div>
                      </td>
                      <td className='px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap'>
                        <div className='inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-yellow-100/60 text-yellow-500'>
